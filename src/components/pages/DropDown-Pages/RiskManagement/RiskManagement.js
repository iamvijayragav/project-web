    ...
    <div className="risk-container">
      ...
      <div className="engineer-paragh">
        ...
        <p>
          ...
          safety within your company, community, and the environment. We create
          a repeatable risk management program that strives to eliminate
          deviations and redundancies and can be sustained cost-effectively. We
          can also provide individual risk management assistance where our
          expertise is needed.
        </p>
        <p>
          Because we understand the issues facing your business and industry, we
          can help you prepare for audits, inspections, and internal reporting
          mandates.
        </p>
      </div>
