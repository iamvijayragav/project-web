  ...
  return (
    <div className="risk-container">
      ...
      <div className="engineer-paragh">
        <h3>
          Translating Mechanical Integrity and Compliance Needs into Maintenance
          Systems
        </h3>
        <p>
          Tecnicoe works with our clients to help meet their plant and facility
          maintenance program requirements to improve efficiencies and track
          compliance assurance.
        </p>
        <ul>
          <li>
            Help identify Asset Integrity tasks regulatory requirements such as
            DOT/PHMSA, OSHA/PSM, and EPA. Conduct RCM/RBI and criticality
            studies as necessary.
          </li>
          <li>
            Define equipment data structure and collect via facility walkdowns,
            drawings, existing data sources, etc.
          </li>
          <li>
            Develop maintenance strategies, procedures, and tasks to satisfy the
            asset integrity and compliance requirements. Design reports and
            KPIs.
          </li>
          <li>
          ...
          <li>
            Define spare part data structure, develop spare parts, and bills of
            material (BOM).
          </li>
          <li>
        ...
        <p>
          ...
          Essentials/Dude Solutions and integration with various RBI, corrosion
          monitoring, and document management applications.
        </p>
      </div>
